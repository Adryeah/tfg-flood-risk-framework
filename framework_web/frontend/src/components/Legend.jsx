...
export function GradientLegend({ title = 'Flood probability', minLabel = '0.25', maxLabel = '1.00', note = '< 0.25 transparent' }) {
  return (
    <div
      ...
      style={{ background: 'rgba(250,251,252,0.92)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 1px 2px rgba(255,255,255,0.06)' }}
    >
      ...
      <div className="flex h-2 sm:h-2.5 rounded-sm overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.08)' }}>
        {RISK_PALETTE.map((c) => (
      ...
      {note && (
        <span className="hidden sm:inline text-10 ml-1 pl-2.5" style={{ color: '#98A2B3', borderLeft: '1px solid rgba(255,255,255,0.08)' }}>
          {note}
        </span>
      )}
    </div>
