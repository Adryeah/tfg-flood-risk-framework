...
const EN_ES = {
  ...
  'Valencia OOF · threshold 0.160': 'Valencia OOF · umbral 0.160',
  ...
  'Harmonic mean of precision and recall at the operational decision threshold (0.160). Picked by maximising F1 on the validation folds — balances false alarms vs missed floods.':
    'Media armónica de precisión y recall en el umbral de decisión operativo (0.160). Elegido maximizando F1 en los folds de validación — equilibra falsas alarmas frente a inundaciones perdidas.',
  ...
  '2 × 2 contingency table of predictions at the operational threshold (0.160). TP = correctly flagged flood; FN = missed flood (worst case); FP = false alarm; TN = correctly clear pixel. Out-of-fold predictions only — no train-set leakage.':
    'Tabla de contingencia 2 × 2 de predicciones en el umbral operativo (0.160). TP = inundación marcada correctamente; FN = inundación no detectada (peor caso); FP = falsa alarma; TN = píxel seco correctamente clasificado. Solo predicciones out-of-fold — sin fuga del conjunto de entrenamiento.',
  ...
  '(original 0.160 was recalibrated because positive prevalence differs by ~27× — 0.29 % vs 7.98 %). Switch to Binary to apply the slider live to the map.':
    '(el original 0.160 se recalibró porque la prevalencia positiva difiere ~27× — 0.29 % vs 7.98 %). Cambia a Binario para aplicar el slider en vivo al mapa.',
